...
SubProceso opcion <- programas
	...
	Escribir "[8] -----Encriptando el mensaje-----";
	Escribir "[9] -------------Salir--------------";
	Escribir "    --------------------------------";
	Escribir "    ---------Algoritmos-------------";
	...
	segun opcion hacer
		...
		2:
			...
			escribir "Algoritmo Aritmetica o Geometrica";
...
FinSi
		...
		4:
			...
			Escribir "Algoritmo La Parranda";
		...
		5:
			...
			Escribir "Algoritmo Velocidad Maxima";
		...
		6:
			...
			Escribir "Algoritmo Reparit Par";
		...
		7:
			...
			Escribir "Algoritmo Contando los enteros de la linea";
